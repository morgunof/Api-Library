...
import {CATEGORY_SELECT_OPTIONS, SORT_SELECT_OPTIONS} from '../../api/form';
            ...
            <FormGroup className='mt-2 '>
                <Row className='justify-content-center'>
                    <Col className='me-2' xs md={2}>
                        <FormLabel className='text-white'>Категиории:</FormLabel>
                    ...
                    <Col className='ms-2' xs md={2}>
                        <FormLabel className='text-white'>Сортировка:</FormLabel>
